defmodule SymphonyElixir.Tracker do
  ...
  def fetch_issue_states_by_ids(pipeline, issue_ids)
      when is_map(pipeline) and is_list(issue_ids) do
    pipeline
    |> adapter()
    ...
    case Code.ensure_loaded(adapter) do
      {:module, _module} ->
        cond do
          ...
          fallback_args != [] and
              function_exported?(adapter, function_name, length(fallback_args)) ->
